...
library NFTPositionInfo {
    ...
    function getPositionInfo(
        ...
        IMNonfungiblePositionManagerII nonfungiblePositionManager,
        uint256 tokenId
    )
        internal
        view
        returns (
            IMNonfungiblePositionManagerII.IUniswapV3Pool pool,
            int24 tickLower,
            int24 tickUpper,
            uint128 liquidity
        )
    {
        ...
        pool = IMNonfungiblePositionManagerII.IUniswapV3Pool(
            MPoolAddress.computePoolAddress(
                address(factory),
                token0,
                token1,
                fee
