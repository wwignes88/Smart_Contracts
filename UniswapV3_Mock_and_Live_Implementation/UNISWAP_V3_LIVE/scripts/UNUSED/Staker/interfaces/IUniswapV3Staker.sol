...
interface IUniswapV3Staker is 
    ...
    /// @return ownerEOA EOA account of deposit owner (if it is contract, else same as)
    ...
    function rewards(MERC20 rewardToken, address owner) external view returns (uint256 rewardsOwed);
    ...
    function transferDeposit(uint256 tokenId, address to, address operator) external;
    ...
    event DepositTransferred(uint256 indexed tokenId, 
